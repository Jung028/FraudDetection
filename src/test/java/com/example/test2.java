...
//     public test2(String claimId, String policyNumber, int policyholderAge, String policyholderGender,
//                  String policyType, String incidentType, LocalDate incidentDate, LocalDate reportedDate,
//                  String location, String damageSeverity, double claimAmount, int settlementTime, boolean supportingDocsProvided) {        this.claimId = claimId;
